...
public class MoonAdapter extends RecyclerView.Adapter<MoonAdapter.MoonViewHolder>{
    ...
    @NonNull
    @Override
    public MoonAdapter.MoonViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.choose_enc_item, parent, false);
        return new MoonViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MoonAdapter.MoonViewHolder holder, int position) {
