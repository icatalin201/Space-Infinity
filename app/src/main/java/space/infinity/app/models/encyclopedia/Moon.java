...
public class Moon implements Parcelable{
    ...
    public Moon(int id, String name, String description, String image, String diameter,
                String mass, String orbits, String orbitDistance, String orbitPeriod,
